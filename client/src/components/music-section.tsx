...
const favoriteArtists = [
  ...
  spotifyEmbed: "https://open.spotify.com/embed/album/0kT2Dn4QknHk92h76ZcMk0",
  spotifyUrl: "https://open.spotify.com/album/0kT2Dn4QknHk92h76ZcMk0",
  gradient: "from-indigo-500 to-purple-500",
  albums: ["flaws and all 0.2"],
  }, 
  {
    name: "Rex Orange County",
    genre: "Indie Pop / Alternative",
    description: "That British charm with emotional lyrics. Perfect for those deep thinking moments and late night drives.",
    spotifyEmbed: "https://open.spotify.com/embed/artist/7pbDxGE6nQSZVfiFdq9lOL?utm_source=generator&theme=0",
    spotifyUrl: "https://open.spotify.com/artist/7pbDxGE6nQSZVfiFdq9lOL",
    gradient: "from-orange-500 to-yellow-500",
    albums: ["Pony", "Apricot Princess", "WHO CARES?"],
  },
  {
    name: "Mitski",
